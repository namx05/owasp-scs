...
If your proposal qualifies for the SCSTG/SCSVS we'll convert it into an "Issue" (the discussion might take a while).
   - SCSVS Example: "Add a SCSVS-CODE requirement on Key rotation"
   - SCSTG Example: "Add a Test case for key rotation"
